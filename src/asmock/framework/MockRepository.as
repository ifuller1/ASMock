package asmock.framework
{
	...
	public class MockRepository
	{
		...
		private var _mockObjectStates : Dictionary = new Dictionary(true);
		private var _mockBases : Dictionary = new Dictionary(true);
		...
		private static var _defaultProxyRepository : IProxyRepository = new ProxyRepository();
		...
		public function stubAllProperties(mock : Object) : void
		{
			...
			var mockBase : Class = _mockBases[mock];
			
			//var properties : Array = Type.getType(mock).getProperties(false, true);
			var properties : Array = Type.getType(mockBase).getProperties(false, true);
